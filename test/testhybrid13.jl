...
@date s1 = d["corpus"][1]
@date p1 = KUparser.Parser{:ArcHybrid13}(wcnt(s1), ndeps)
@date r0 = rparse(:ArcHybrid13, d["corpus"], ndeps)
@show evalparse(r0, d["corpus"])
@date f1 = Flist.tacl13hybrid
@date r1 = oparse(:ArcHybrid13, d["corpus"], f1, ndeps)
@show evalparse(r1[1], d["corpus"])
@date f2 = Flist.acl11eager
@date r2 = oparse(:ArcHybrid13, d["corpus"], f2, ndeps)
@show evalparse(r2[1], d["corpus"])
@date net = KUnet.newnet(KUnet.relu, KUparser.flen(p1,s1,f1), 20000, p1.nmove)
@date r3 = gparse(:ArcHybrid13, d["corpus"], net, f1, ndeps)
@show evalparse(r3[1], d["corpus"])
@date r4 = gparse(:ArcHybrid13, d["corpus"], net, f1, ndeps, 9999)
